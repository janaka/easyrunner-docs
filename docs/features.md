---
title: Features
description: EasyRunner is two building blocks on one setup — web app hosting and AI agent sandboxes, both on infrastructure you own.
social:
  cards_layout_options:
    title: Two building blocks, one setup
---
...
-   :material-server-network: **Web app hosting** — available now
    ...
    [:octicons-arrow-right-24: What's in it](web-app-hosting.md)
...
-   :material-robot-outline: **AI agent sandboxes** — in development
    ...
    [:octicons-arrow-right-24: What it's for](ai-agent-sandbox.md)

</div>

[Deploy your first app →](user-docs/quickstart/first-app.md){ .md-button .md-button--primary }
[See pricing](pricing.md){ .md-button }
